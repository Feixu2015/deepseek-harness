...
export class WorkspaceManager {
  ...
  /**
   * Permanently delete one archived session, then install the returned full
   * set without waiting for the changed frame.
   * @param sessionId - archived session to delete.
   * @returns the wire result.
   */
  async deleteArchivedSession(sessionId: SessionId): Promise<RpcResult<{ archivedSessionIds: SessionId[] }>> {
