...
export const en = {
  ...
  fetchNoResults: 'No matching models.',
  listSearchPlaceholder: 'Search configured models…',
  listSelectAll: 'Select all',
  listDeselectAll: 'Deselect all',
  listDeleteSelected: 'Delete selected',
  listNoResults: 'No matching models.',
  listDeleteCount: '{count} selected',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  fetchNoResults: '没有匹配的模型。',
  listSearchPlaceholder: '搜索已配置模型…',
  listSelectAll: '全选',
  listDeselectAll: '取消全选',
  listDeleteSelected: '删除所选',
  listNoResults: '没有匹配的模型。',
  listDeleteCount: '已选 {count} 项',
  customAdd: '添加自定义提供方',
  customTitle: '自定义提供方',
  customTag: '自定义',
  customRoute: 'Provider ID',
