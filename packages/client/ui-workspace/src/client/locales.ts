...
export const zh = {
  ...
  'archive.section.title': '归档会话',
  'archive.empty': '暂无归档会话',
  'archive.activate': '激活',
  'archive.delete': '删除',
  'archive.activate.aria': '激活会话“{name}”',
  'archive.delete.aria': '删除会话“{name}”',
  'archive.delete.confirm.title': '删除归档会话',
  'archive.delete.confirm.desc': '确定要永久删除会话"{name}"吗？此操作将删除所有会话数据，无法撤销。',
  'archive.count.one': '{n} 个归档会话',
  'archive.count.other': '{n} 个归档会话',
...
export const en = {
  ...
  'archive.section.title': 'Archived sessions',
  'archive.empty': 'No archived sessions',
  'archive.activate': 'Activate',
  'archive.delete': 'Delete',
  'archive.activate.aria': 'Activate session {name}',
  'archive.delete.aria': 'Delete session {name}',
  'archive.delete.confirm.title': 'Delete archived session',
  'archive.delete.confirm.desc': 'Are you sure you want to permanently delete session "{name}"? This will delete all session data and cannot be undone.',
  'archive.count.one': '{n} archived session',
  'archive.count.other': '{n} archived sessions',
